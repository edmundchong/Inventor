...
tk.Button(button_frame, text="Spin Left", font=button_font, width=15,
          command=lambda: send_command("R", "Spinning Left (Manual)")).grid(row=0, column=0, padx=10, pady=5)

tk.Button(button_frame, text="Spin Right", font=button_font, width=15,
          command=lambda: send_command("L", "Spinning Right (Manual)")).grid(row=1, column=0, padx=10, pady=5)
